...
import { ZAPIClient, extractInstanceId } from "../services/zapi";
 ...
 */
export function registerZAPIRoutes(app: Express, apiPrefix: string) {
  // Diagnóstico de configuração da Z-API
  app.get(`${apiPrefix}/zapi/diagnostics`, isAuthenticated, isAdmin, async (req: Request, res: Response) => {
    try {
  ...
  app.get(`${apiPrefix}/zapi/status`, isAuthenticated, async (req: Request, res: Response) => {
    try {
      const client = ZAPIClient.fromEnv();
  ...
  // Obter QR Code
  app.get(`${apiPrefix}/zapi/qrcode`, isAuthenticated, isAdmin, async (req: Request, res: Response) => {
    try {
      const client = ZAPIClient.fromEnv();
  ...
  // Reiniciar conexão
  app.post(`${apiPrefix}/zapi/restart`, isAuthenticated, isAdmin, async (req: Request, res: Response) => {
    try {
      const client = ZAPIClient.fromEnv();
  ...
  app.post(`${apiPrefix}/zapi/extract-id`, isAuthenticated, isAdmin, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${apiPrefix}/zapi/send-text`, isAuthenticated, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${apiPrefix}/zapi/test-connection`, isAuthenticated, isAdmin, async (req: Request, res: Response) => {
    try {
